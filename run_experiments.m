...
ex(end+1).trainOpts = struct(...
    ...
    'dataset', 'ModelNet40', ...
    'batchSize', 60, ... % change to 80 to train the model without upright assumption
    'aug', 'none', ...
    'numEpochs', 15, ...
    'gpuMode', true, ...
    'includeVal', true, ...
    'useUprightAssumption', false);  % change to true to train the model without upright assumption
...
% experiment unit 
ex(end+1).trainOpts = struct(...
    'baseModel', 'imagenet-vgg-m-finetuned-ModelNet40-BS60_AUGnone', ... % change to BS80 if you use batch size 80
    'dataset', 'ModelNet40', ...
    'batchSize', 60, ... % change to 80 to train the model without upright assumption
    'aug', 'none', ...
    'numEpochs', 10, ...
