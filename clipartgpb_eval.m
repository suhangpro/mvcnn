...
imdb = load('data/v1/clipartgpb-seed-01/imdb/imdb-seed-1.mat');
load('data/v1/clipartgpb-seed-01/fc7.mat');
...
fprintf('Accuracy on clipartgpb dataset (val): %g\n',bestcv);
fprintf('Accuracy on clipartgpb dataset (test): %g\n',accuracy(1));
